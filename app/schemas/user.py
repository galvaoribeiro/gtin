...
class UserResponse(UserBase):
    ...
    plan: Optional[str] = Field(None, description="Plano atual: basic, starter, pro, advanced, enterprise")
    monthly_limit: Optional[int] = Field(None, description="Limite mensal do plano")
    batch_limit: Optional[int] = Field(None, description="Limite de GTINs por consulta em lote")
